...
class FSRequest:
    ...
    def updateProgress(count, blockSize, totalSize):
        global GLOBAL_DOWNLOAD_TRACKER
        percent_downloaded = round(count * blockSize * 100 / totalSize)
    ...
    @classmethod
    def retrieve(cls, url, client, path, reporthook=updateProgress):
        """
